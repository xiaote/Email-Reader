...
testCases1=["12:30-2 p.m. - Lunch at Table No.",
"2:30 -4:30 p.m. - Tour at The Power Station of Art",
"Lets meet 5:30 tomorrow",
"""[CS-undergrads] Deeplocal Meet&Greet: Tues 12 Nov / I/O
Desk GHC 5th floor / 11:00-2:00""",
"11:00 am - 2:00 pm",
"12:00-1:30PM VMWare Tech Talk - Ravi Soundararajan - GHC 6115",
"4:30-5:30PM Special SCS Industry Talk -GHC 6115",
"12:30-2:00PM LaunchCMU: A Research and Entrepreneurship Showcase",
"4:30-6:00PM SCS4ALL Undergraduate Pre-Registration Event - GHC 4405",
"Time: 1:00 pm to 4:00 pm",
"8:30 am to 5:00 pm.",
"Question about class  (11/12/13 5:07 PM",
"session on 11/14, this Thursday at 4:30 p.m. in DH1212",
"12:30 pm     2nd Annual Alumni, Faculty and Student Theater & Music Jam",
"It will be from *5:00pm - 7:30pm *in *Rashid (GHC 4401) *with a *CAKE",
"*5:30 - 7:00pm: *Demos",
"Dance 9:00p-12am"]

testCases2=["""The exam is from 6:30pm-9:30pm on Thursday, November 21
in Porter Hall 100.""",
"The presentation will be held at 6:00PM on Wednesday in Simon Auditorium.",
"It will be on *November 22 (Friday)* from *5-7:30pm* in *Rashid *(subject",
"It will be from *5:00pm - 7:30pm *in *Rashid (GHC 4401) *with a *CAKE",
"from  4:30-6:30pm in the Dowd Room on the second floor of the UC.",
"Hot Metal Blues at Peter's Pub in Oakland",
"Snowbound Blues in Rochester, NY",
"(11/21) at The Porch at Schenley.",
"""The 2nd Intro to Sales and Trading class will be in Tepper Room 324
on Thursday at 4:30pm.""",
"Location: Posner Hall, Simon Auditorium",
"at K&L Gates of Pittsburgh",
"Location: Newell Simon Hall, Room 3005",
"Location: Hamburg Hall, Room 1001",
"12:00-1:20PM 'The Curated Arts Experience' - Hamburg Hall 1001",
"4:30-5:30PM Machine Learning/Google Distinguished Lecture - GHC 4401",
"4:30-5:30PM Machine Learning/Google Distinguished Lecture - GHC 4401",
"5:00-6:00PM Friedman Internships Information Session - Danforth Lounge, UC",]

interestingCases3=["""Just as a reminder, choreographer auditions is TODAY
NOVEMBER 16TH 9AM - 12PM in the Morewood Multipurpose Room.""",
"""Just be sure to send a video of your auditioning piece to
Sandra at scyeh@andrew.cmu.edu <scyeh@andrew.cmu.edu> on November 24th by
11:59pm!""",
"""One last thing...come out to Tangyuan Night
<https://www.facebook.com/events/693511217327553/> tonight at 8pm in Stever!""",
"Here is the full schedule:  5:00 - 5:30pm: Dinner and sign in.",
"""5:30 - 7:00pm: Demos 7:00 - 7:30pm: Judging and Prizes
7:30 - 8:00pm: CAKE  Please sign up here <http://goo.gl/XekjiN> by
Tuesday so we can plan for food.""",
"""It will be on November 22 (Friday) from 5-7:30pm in Rashid
(subject to change).""",
"""Monday, November 18: - 8pm, McGill Lounge - 8pm, Scobell Lounge
Tuesday, November 19: - 8pm,  E-Tower 5th Floor Lounge
Wednesday, November 20: - 8pm, Stever Dining Room - 8:30pm, Rez Lounge
Thursday, November 21: - 9pm, Mudge Piano Room""",
"""Time: 5:00 pm to 6:00 pm  Location: Posner Hall, Simon Auditorium
Food will be provided""",
"""Time: 5:00 pm to 6:00 pm  Location: Posner Hall, Simon Auditorium
Food will be provided  Register (http://e2.ma/click/5q4bv/91r4mq/dxmcbg)
=20  Brought to you by the Undergraduate Entrepreneurship Association at the
Tep= per School of Business  Tuesday, November 19  Start Smart Seminar:
Protecting Your Company's Intellectual Property  Learn how to protect your
company's IP with presenter David Lehman, Partner=  at K&L Gates of
Pittsburgh.""",
"""Time: 5:30 pm to 7:00 pm  Location: Newell Simon Hall, Room 3005  Light food
will be provided  Register (http://e2.ma/click/5q4bv/91r4mq/tpncbg)  =20
Brought to you by Project Olympus & The Innovation Practice Institute at th= e
University of Pittsburgh  Wednesday, November 20  Think Like An Angel:
Entrepreneurial Challenge  =20  Modeled after VCIC
(http://e2.ma/click/5q4bv/91r4mq/9hocbg) , Think Like an=  Angel is a unique
twist on the formula.""",
"""Time: 5:30 pm to 9:30 pm  Location: Newell Simon Hall, Room 3305 & 1507
Light food will be provided  Register
(http://e2.ma/click/5q4bv/91r4mq/52pcbg)  Brought to you by the EVC Club at
the Tepper School of Business and Blue Tr= ee Allied Angels  Thursday, November
21  Startup Job Fair  =20  Over 30 startups looking for full-time, part-time,
interns and co-founders = in software development, design, marketing and
business development will be=  gathered in one place to recruit talent to
help with their startups.""",
"""vTo learn more, drop in at the iGEM Info Session on Monday November 25th from
4:30-6:30pm in the Dowd Room on the second floor of the UC.""",
"""Date: Wednesday, November 20th (tomorrow) Time: 6:00PM-7:00PM
Location: Simon Auditorium Pizza will be provided  All,  Tomorrow we will have
Constantine Mamakos of Quaker Capital Management run through a long/short
equity strategy case."""]                  

testCases4=["Startup Job Fair at CMU on Thursday, Nov. 21",
"""Thursday, November 21  Startup Job Fair =20  Over 30 startups looking for
full-time, part-time, interns and co-founders in software development, design,
marketing and business development will be gathered in one place to recruit
talent to help with their startups.""",
"""Time: 3:30 pm to 7:00 pm  Location: Newell Simon Hall, Perlis Atrium
Light food will be provided  Register (http://e2.ma/click/9dhcv/91r4mq/pewcbg)
Brought to you by Pittsburgh Meetup and Project Olympus
(http://e2.ma/click/9dhcv/91r4mq/56wcbg)  =20   5000 Forbes Avenue | Pittsburgh,
PA 15213-3890    ___________________________________   Share This:=20
http://e2.ma/share/outbound/e/9dhcv/91r4mq [Share via Email]   This email was
sent to xiaotez@andrew.cmu.edu.""",
"[CS-undergrads] SCS Undergraduate News - 11/18/2013",
"The last day to drop or elect pass/fail is Tuesday, November 19.",
"""UPCOMING EVENTS  /Wednesday, Nov 20/ 5:00-6:00PM SCS4ALL General Meeting
- GHC 7101 http://scs4all.cs.cmu.edu/ 6:00PM Hadoop Users Group Meeting - 300
S. Craig Street http://www.meetup.com/HUG-Pittsburgh/events/147624752/  /
Thurs, Nov 21/ 12:00-1:20PM 'The Curated Arts Experience' - Hamburg Hall 1001
/The Master of Arts Management (MAM) Speakers Series presents Ceci  Dadisman,
director of marketing and public relations at the Palm Beach  Opera, where she
manages the company's technology and new media  projects, including social
media, website and live Web streaming.""",
"""Nov 21, 25  If you plan to study abroad during the Spring 2014 semester or
over  Winter Break 13-14, you are REQUIRED to attend one of these events this
semester.""",
"""Necessary skills/prerequisites: Experience with Google tools and Google
Earth, GPS Project/job duration: Approximately 2-4 weeks  Contact information:
Albert Presto, Assistant Research Professor, Dept.""",
"""of Mechanical Engineering albert.presto@gmail.com
SCHOLARSHIP/EDUCATION/CONFERENCE OPPORTUNITIES  Friedman Internships Information
Session - Nov 21, 2013, 5:00 PM Danforth Lounge, University Center All Carnegie
Mellon undergraduates and graduate students from any  college or school who have
a strong academic record and would value the  opportunity to spend a summer
gaining firsthand policy experience in a  public or private sector in
Washington, D.C., are invited to apply for a  Friedman internship.""",
"""By applying to the Microsoft Scholarship Program  -- students may be eligible
for full or partial tuition for the  2014-2015 academic year.""",
"Applications must be received by: January 31st, 2014  -------- GOT NEWS?",
"""Cheryl www.tartanswing.com  Events this week:  Tonight: Hot Metal Blues at
Peter's Pub in Oakland Lesson 8:00-9:00pm Dance 9:00pm-12am Free!""",
"""116 Oakland Ave http://www.hotmetalblues.com/  Coming Up (events some of our
dancers are attending): Snowbound Blues in Rochester, NY 12/13-15
http://www.snowboundblues.com/  Lindy Focus in Asheville, NC 12/27-1/1
http://lindyfocus.com"""]

testCases5=["""The exam will be available from June 3rd until July 29th,
but please check with your advisor for your college's deadline for completion
of the test.""",
"""On 6/12/2013 11:11 AM, xiaotez@andrew.cmu.edu wrote:  > Hi Jacobo, > > I have
had some programming experience so I am going to take the CS > placement test
as soon as possible.""",
"""You can send your scores by:  =95 FAX at 412-268-5573 Attention : Jacobo
Carrasquel  =95 or by creating a .pdf file and emailing it to me as an
attachment -- jacobo@cs.cmu.edu  =95 or by taking a digital photo and emailing
it to me as an attachment -- jacobo@cs.cmu.edu    --=20 Thanks,  Jacobo
Carrasquel=09 Associate Teaching professor and Computer Science Advisor  Office:
412-268-6729 Fax:    412-268-5573""",
"[CS-undergrads] Student Advisory Committee meeting TODAY at 4:30PM",
"Our next SAC meeting is today, 4:30PM in GHC 8102",
"""The End of Object Inheritance & The Beginning of a New Modularity Tuesday,
November 12, 2013 - 4:30-5:30PM - GHC 6115  ABSTRACT: After 15 years of
combined experience developing software of  all types we are done with
inheritance.""",
"""ello errbody,  We'll be having the meeting in WW TV LOUNGE at 5:30pm on
Wednesday !!"""]
